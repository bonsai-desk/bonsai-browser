...
think clearly
    <br />
    <a href="https://github.com/Bonsai-Desk/bonsai-browser"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/Bonsai-Desk/bonsai-browser">View Demo</a>
    ·
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `Bonsai-Desk`, `bonsai-browser`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `Bonsai Browser`, `Web-browser for research that helps programmers think clearly`
...
2. Clone the repo
   ```sh
   git clone https://github.com/Bonsai-Desk/bonsai-browser.git
   ```
...
See the [open issues](https://github.com/Bonsai-Desk/bonsai-browser/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/Bonsai-Desk/bonsai-browser](https://github.com/Bonsai-Desk/bonsai-browser)
